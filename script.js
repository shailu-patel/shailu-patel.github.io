...
// /// toggle icon navbar//////////////
// // Select all elements with the class "menu-icon"
...
//     // Remove the "bx-x" class from all menu icons
//     menuIcons.forEach(menuIcon => {
//         menuIcon.classList.remove("bx-x");
//     });
    
//     // Remove the "open" class from the navigation list
...
const observer = IntersectionObserver((entries) => {
    entries.forEach((entry) => {
        if (entry.isIntersecting) {
            entry.traget.classList.add("show-items");
        } else {
